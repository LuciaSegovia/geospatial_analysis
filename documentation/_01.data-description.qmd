...
3) Agro-eco based: Lastly, we will used the agro-ecological areas (also used in IHS4) to aggregate the data. 

#REVIEW: We were thinking to use the soil type as well, but maybe we will have some kind of cofounding if we are using that as one of the covariates of the model. 
