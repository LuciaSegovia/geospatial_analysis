...
## 4) Maize Se concentration in Malawi (GeoNutrition, Gashu et al., 2019)
...
In order to minimise the impact on our model, and after checking that maize consumption is the same as other regions in Malawi (even slightly higher), we are including maize samples from other two studes (see data section)

## 5) Maize Se concentration in Malawi (Joy et al., 2014)
...
## 6) Malawi GPS data & country boundaries 
