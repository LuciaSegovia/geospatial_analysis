...
ea_admin <- ea_bnd %>% select(c(4, 10, 11, 17, 18))
...
Therefore, we decided to use the EAs centroids to standardise/ minimise the measurement error from the off-setting of the coordinates. Two buffer distances were selected:
