...
The first step is to identify the Enumeration Areas where each maize grain were sampled. We started with the Enumeration Areas because there are the smallest administrative units, and they are nested within the other (bigger) administrative units (Districts and Regions). 
...
#### Enumeration Areas of household locations. 
