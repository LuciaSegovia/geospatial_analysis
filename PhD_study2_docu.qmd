...
Malawi maize grain and soil Se concentration dataset. It is publicly available [here](https://github.com/rmlark/GeoNutrition/tree/main/Soil_Crop_comparisons/Malawi)
...
#TODO: Getting the AEZ from the Scoping review (R prjct, data folder).
