...
- GADM maps and data (gadm40_MWI_shp): The file for the EAs has some issues that lead some points in the lake. Hence, we found a different file with the Malawi boudaries. 

- GeoBoundaries: It also has 3 level of boudaries: 1-region, 2-district, 3-TA. These files has no EA boundaries (depricated).

- Echo2 priritization: These files covered up to EAs.

- Malawi NSO from HDX (Humanitarian datasets) (mwi_adm_nso_hotosm_20230329)
