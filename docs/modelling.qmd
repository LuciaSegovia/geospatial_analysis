...
p(s_i) = \beta_0(cluster) + \beta_1X_1 + \psi(s_i)
...
Also, although non-significant we could see a pattern for the wealth Q, with the low-est Q negative influencing plasma Se and high-est positively.
