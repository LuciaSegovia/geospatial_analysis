...
One thing is tricking is that there are more maize samples per district when using the EA as opposed to the district boundaries. However, when plotting them against each other it seems that there are in aggreement and closelly aligned. 
