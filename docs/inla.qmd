...
After that we need to prepare the stack. This is a useful function where you can stack the data. Here, we combine the SPDE model that will be defined in the triangle nodes (*m*) and the covariates and the intercept at the point locations (*n*). 
