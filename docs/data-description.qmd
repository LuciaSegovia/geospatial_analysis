...
- **Low data availability in Southern Malawi region**. For instance,in our main dataset, the GeoNutrition, mainly other crops (e.g., sorghum, millet, etc.) were collected (~11%) in the Southern region.
...
## Se biomarker dataset (DHS-MNS) {#sec-plasma}
